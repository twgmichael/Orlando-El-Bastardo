...
def render_mission_scene(mission: dict[str, Any], contracts: dict[str, dict[str, Any]]) -> str:
    ...
    lines.extend(
        [
            ...
            'text = "JOURNEYBLASTER · MISSION 001 · DEMO PROTOTYPE V4"',
            "",
            ...
            'text = "W/S throttle · ` reverse 25% · A/D or ←/→ turn · ↑/↓ pitch · Q/E roll · X recenter · TAB all stop · ESC mouse · ⌃⌘F fullscreen · LMB FRAPRAY · HOLD/RELEASE RMB TORPEDO\\nZ/C strafe · R/F lift · G interact · \\\\ aim HUD · MMB chair look · -/+ views · L course lock · F3 exterior"',
