...
PAGES = [
    ...
    ("docs/planning/ASSET-LOCATION-ORIENTATION-STANDARD.md",
     "Asset-Location-Orientation-Standard", "Standards",
     "Asset Location Orientation Standard"),
    ("docs/planning/DOCUMENTATION-TAXONOMY-AND-METADATA.md",
     "Documentation-Taxonomy-And-Metadata", "Standards",
    ...
    ("docs/planning/PUBLISHING-PLAN.md",     "Publishing-Plan",
     "Planning", "Publishing Plan"),
    ("docs/planning/WIKI-SYNC-PLAN.md",      "Wiki-Sync-Plan",
     "Planning", "Wiki Sync Plan"),
    ...
    ("docs/planning/AGENT-BUS-PLAN.md",          "Agent-Bus-Plan",
     "Planning", "Agent Bus Plan"),
    ("docs/planning/PRODUCTION-DESIGNER-PLAN.md", "Production-Designer-Plan",
     "Planning", "Production Designer Plan"),
    ("docs/planning/WORKER-AGENT-PLAN.md",        "Worker-Agent-Plan",
     "Planning", "Worker Agent Plan"),
    ("docs/planning/STUDIO-HARNESS-VISION.md",    "Studio-Harness-Vision",
    ...
    ("docs/planning/SCENE-GRAPH-PRIMITIVE-BUILDER-PLAN.md",
     "Scene-Graph-Primitive-Builder-Plan", "Planning",
     "Scene Graph Primitive Builder Plan"),
    ("docs/planning/STUDIO-CHAT-ENDPOINT-PLAN.md", "Studio-Chat-Endpoint-Plan",
     "Planning", "Studio Chat Endpoint Plan"),
    ("docs/planning/STUDIO-STATE-ENDPOINTS-PLAN.md", "Studio-State-Endpoints-Plan",
     "Planning", "Studio State Endpoints Plan"),
    ("docs/planning/LOCAL-WORKER-OPERATIONS-FIX-PLAN.md",
     "Local-Worker-Operations-Fix-Plan", "Planning",
